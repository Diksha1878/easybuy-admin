							...
							<div class="col-md-12">
								...
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
										<i class="fa fa-globe"></i>Wishlist </div>
										<div class="tools"> </div>
									</div>
										...
										<table class="table table-striped table-bordered table-hover" id="sample_2">
											...
											<tbody>
												<?php 
													...
													$rows = get_row($conn, "select  * from wishlists where id!='' $search_date order by id desc");
													...
													foreach($rows as $row){
														...
														$product = get_row($conn, "select * from products where id='{$item[0]['pid']}'");
													?>
													...
													<tr>
														...
														<td><a href="product_details/<?php echo md5($product[0]['id'])?>"><?php echo $product[0]['name']; ?></a></td>
														<?php $color = get_row($conn, "select * from colors where id='{$item[0]['color']}' LIMIT 1"); ?>
														<?php $size = get_row($conn, "select * from sizes where id='{$item[0]['size']}' LIMIT 1"); ?>
