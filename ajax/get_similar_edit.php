	...
	<div class="row" style="margin-bottom: 10px;">
		<div class="col-md-12">
			<div class="form-group">
				<label style="padding-left:0;" class="control-label col-sm-9" for="email">
					<input type="text" placeholder="Product Name" id="combo_name" value="<?php echo $product[0]['name'] ?? ''; ?>" class="form-control" disabled>
