...
<div id="box<?php echo $id; ?>">
	<input id="box_status<?php echo $id; ?>" type="hidden" name="box_status[]" value="insert">
    ...
    <div id="box_ribbon<?php echo $id; ?>" style="width: 100%;text-align: left;padding: 10px;border: solid 1px #F44336;background: #ff6156;color: #fff;font-weight: bold;">Variety <?php echo $id+1; ?> <span id="box_ribbon_text<?php echo $id; ?>"></span></div>
	<div id="box_head<?php echo $id; ?>">
		<div style="border-radius: 4px;border-top-left-radius:0;border-top-right-radius:0;padding: 15px;border: solid 1px #ccc;background: #f9f9f9;">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" placeholder="Enter SKU" id="sku" name="sku[]" />
					<span class="help-block"> </span>
				</div>
			</div>
			<div class="form-group">
